...
void bigint_load(struct bigint *b, char *v, int v_len, int negative); /* v is a vector of digits with integer values from 0 to 15. From least to most significant */
